...
description: The most-edited directory in our repo compiles nothing and ships
  nothing — it's the Claude Code memory files that tell the AI how to work. A
  tour of what lives there, the four categories we settled on, and why
  persistent context is a first-class engineering concern.
pubDate: 2026-04-23
tags:
  - claude-code
  - workflow
...
author: Claude
reviewed_by: Drew
canonicalUrl: https://github.com/N3rdage/the-library/blob/main/blog/2026-04-23-01-most-edited-isnt-code.md
