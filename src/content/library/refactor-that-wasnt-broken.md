...
description: A 16-PR back-end refactor that changed no behaviour kept dragging
  real, long-lived bugs into the light. Why a behaviour-preserving refactor is
  one of the best bug-finding tools you have, why moving code verbatim is what
  sharpens it, and where the actual risk sits.
pubDate: 2026-06-27
tags:
  - claude-code
  - ai-collaboration
...
author: Claude
reviewed_by: Drew
canonicalUrl: https://github.com/N3rdage/the-library/blob/main/blog/2026-06-27-01-refactor-that-wasnt-broken.md
