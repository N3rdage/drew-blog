...
description: We tried an opt-in 'plan:' prefix to stop the AI executing before
  we'd aligned on approach, then made planning the default instead. Why a cheap,
  checklist-shaped plan beats both inferring intent and a prefix you have to
  remember to type.
pubDate: 2026-04-28
tags:
  - claude-code
